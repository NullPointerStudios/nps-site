...
class Star {
  ...
  move(angleOverride: number = 0) {
    if (angleOverride) {
      this.currentRotation = angleOverride;
    }
    if (this.collapsed) {
      this.nextPosition = rotate(this.centerPos, this.startingPosition, (this.counter -= 10));
